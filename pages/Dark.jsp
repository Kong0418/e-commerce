...
<article>
    ...
    <div class="main">
		...
		<%
          ...
          <!--<div class="column">
            <div class="content">
              <img src="../assets/Images/Dark1.jpg" style="width:100%">
              <a href="../pages/Dark1.html"><h3>黑巧克力</h3></a>
            </div>
          </div>
          <div class="column">
            <div class="content">
              <img src="../assets/Images/Dark2.jpg" style="width:100%">
              <a href="../pages/Dark2.html"><h3>黑巧克力蛋糕</h3></a>
            </div>
          </div>
          <div class="column">
            <div class="content">
              <img src="../assets/Images/Dark3.jpg" style="width:100%">
              <a href="../pages/Dark3.html"><h3>黑巧克力軟餅乾</h3></a>
            </div>
          </div>
          <div class="column">
            <div class="content">
                <img src="../assets/Images/Dark4.jpg" style="width:100%">
                <a href="../pages/Dark4.html"><h3>黑巧克力泡芙</h3></a>
            </div>
          </div>-->
        </div>
    </div>
